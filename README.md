...
**An open, vendor-neutral interactive reference for visualising, comparing,
and debugging EMV 3-D Secure (3DS) browser and app flows across published
spec versions.**

[Live Lab](https://cnpshield.github.io/3dslab/) ·
...
> **One paragraph for the impatient:** This is an open, vendor-neutral lab for the
...
> interactive, side-by-side protocol reference built so that security researchers,
> payment engineers, and educators can finally
...
1. **Open the [live lab](https://cnpshield.github.io/3dslab/)** — no install, no auth, no account.
...
> [cnpshield.github.io/3dslab](https://cnpshield.github.io/3dslab/)
...
> [Software]. https://github.com/cnpshield/3dslab
...
- The **researchers and contributors** who file issues, fix typos,
  ...
  [contributors graph](https://github.com/cnpshield/3dslab/graphs/contributors).
...
**EMV 3-D Secure Protocol Lab** · [Lab](https://cnpshield.github.io/3dslab/) ·
[Issues](https://github.com/cnpshield/3dslab/issues) ·
